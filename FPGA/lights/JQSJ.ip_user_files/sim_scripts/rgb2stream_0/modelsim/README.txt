...
#
# Generated by export_simulation on Wed Jul 29 21:55:51 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './rgb2stream_0.sh' script.

./rgb2stream_0.sh -reset_run
...
./rgb2stream_0.sh -noclean_files

For more information on the script, please type './rgb2stream_0.sh -help'.
