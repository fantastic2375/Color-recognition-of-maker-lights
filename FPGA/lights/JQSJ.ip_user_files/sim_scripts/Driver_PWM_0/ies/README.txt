...
#
# Generated by export_simulation on Wed Jul 29 21:51:30 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_PWM_0.sh' script.

./Driver_PWM_0.sh -reset_run
...
./Driver_PWM_0.sh -noclean_files

For more information on the script, please type './Driver_PWM_0.sh -help'.
