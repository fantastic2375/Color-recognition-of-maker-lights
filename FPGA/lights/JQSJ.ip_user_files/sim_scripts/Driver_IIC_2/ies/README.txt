...
#
# Generated by export_simulation on Thu Jul 30 11:06:47 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_IIC_2.sh' script.

./Driver_IIC_2.sh -reset_run
...
./Driver_IIC_2.sh -noclean_files

For more information on the script, please type './Driver_IIC_2.sh -help'.
