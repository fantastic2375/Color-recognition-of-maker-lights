...
#
# Generated by export_simulation on Thu Jul 30 11:04:30 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_IIC_3.sh' script.

./Driver_IIC_3.sh -reset_run
...
./Driver_IIC_3.sh -noclean_files

For more information on the script, please type './Driver_IIC_3.sh -help'.
