...
#
# Generated by export_simulation on Wed Jul 29 22:04:24 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './clk_vip_0.sh' script.

./clk_vip_0.sh -reset_run
...
./clk_vip_0.sh -noclean_files

For more information on the script, please type './clk_vip_0.sh -help'.
