...
#
# Generated by export_simulation on Wed Jul 29 21:01:21 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_MIPI_0.sh' script.

./Driver_MIPI_0.sh -reset_run
...
./Driver_MIPI_0.sh -noclean_files

For more information on the script, please type './Driver_MIPI_0.sh -help'.
