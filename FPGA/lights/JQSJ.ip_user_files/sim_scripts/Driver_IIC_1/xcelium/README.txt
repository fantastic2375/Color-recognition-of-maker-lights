...
#
# Generated by export_simulation on Thu Jul 30 11:01:13 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_IIC_1.sh' script.

./Driver_IIC_1.sh -reset_run
...
./Driver_IIC_1.sh -noclean_files

For more information on the script, please type './Driver_IIC_1.sh -help'.
