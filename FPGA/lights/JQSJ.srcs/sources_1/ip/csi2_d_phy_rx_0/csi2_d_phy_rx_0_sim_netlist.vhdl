...
-- Date        : Wed Jul 29 19:09:18 2020
-- Host        : DESKTOP-NTNJV39 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top csi2_d_phy_rx_0 -prefix
--               csi2_d_phy_rx_0_ csi2_d_phy_rx_0_sim_netlist.vhdl
...
architecture STRUCTURE of csi2_d_phy_rx_0_phy_clock_system is
  ...
  signal \dly_gen.wait_cnt[10]_i_3_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[10]_i_4_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[2]_i_2_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[3]_i_2_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[4]_i_2_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[5]_i_2_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[6]_i_2_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[7]_i_2_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[8]_i_2_n_0\ : STD_LOGIC;
  signal \dly_gen.wait_cnt[9]_i_2_n_0\ : STD_LOGIC;
  ...
  signal p_1_in_carry_i_8_n_0 : STD_LOGIC;
  ...
  signal start_dly_2 : STD_LOGIC;
  signal sum_dly : STD_LOGIC;
  signal wait_cnt : STD_LOGIC_VECTOR ( 10 downto 0 );
  ...
  attribute SOFT_HLUTNM of \dly_gen.curr_delay[3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \dly_gen.curr_delay[4]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \dly_gen.invers_clk_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[10]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[3]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[4]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[5]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[7]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[8]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \dly_gen.wait_cnt[9]_i_2\ : label is "soft_lutpair3";
...
\FSM_sequential_dly_gen.sm_state[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \dly_gen.wait_cnt[6]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[6]\,
      I4 => \dly_gen.wait_cnt_reg_n_0_[8]\,
      I5 => \dly_gen.wait_cnt_reg_n_0_[10]\,
...
\dly_gen.wait_cnt[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEAAEEAAFFEEBABA"
    )
        port map (
      I0 => \dly_gen.wait_cnt[10]_i_3_n_0\,
      I1 => \sm_state__0\(2),
      I2 => \p_1_in_carry__1_n_2\,
      I3 => \FSM_sequential_dly_gen.sm_state[2]_i_2_n_0\,
      I4 => \sm_state__0\(0),
      I5 => \sm_state__0\(1),
      O => wait_cnt_0
    );
\dly_gen.wait_cnt[10]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFE0FF40FF4FFFE"
    )
        port map (
      I0 => \sm_state__0\(0),
      I1 => \p_1_in_carry__1_n_2\,
      I2 => \sm_state__0\(2),
      I3 => \sm_state__0\(1),
      I4 => \dly_gen.wait_cnt_reg_n_0_[10]\,
      I5 => \dly_gen.wait_cnt[10]_i_4_n_0\,
      O => wait_cnt(10)
    );
\dly_gen.wait_cnt[10]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \dly_gen.curr_delay_reg_n_0_[4]\,
      I5 => \sm_state__0\(1),
      O => \dly_gen.wait_cnt[10]_i_3_n_0\
    );
\dly_gen.wait_cnt[10]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      I0 => \dly_gen.wait_cnt_reg_n_0_[8]\,
      I1 => \dly_gen.wait_cnt_reg_n_0_[6]\,
      I2 => \dly_gen.wait_cnt[6]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[7]\,
      I4 => \dly_gen.wait_cnt_reg_n_0_[9]\,
      O => \dly_gen.wait_cnt[10]_i_4_n_0\
    );
\dly_gen.wait_cnt[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFE33CE33CEFFFE"
    )
        port map (
      I0 => \p_1_in_carry__1_n_2\,
      I1 => \sm_state__0\(1),
      I2 => \sm_state__0\(0),
      I3 => \sm_state__0\(2),
      I4 => \dly_gen.wait_cnt_reg_n_0_[0]\,
      I5 => \dly_gen.wait_cnt_reg_n_0_[1]\,
      O => wait_cnt(1)
    );
\dly_gen.wait_cnt[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFE33CE33CEFFFE"
    )
        port map (
      ...
      I2 => \sm_state__0\(0),
      I3 => \sm_state__0\(2),
      I4 => \dly_gen.wait_cnt[2]_i_2_n_0\,
      I5 => \dly_gen.wait_cnt_reg_n_0_[2]\,
      O => wait_cnt(2)
    );
\dly_gen.wait_cnt[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \dly_gen.wait_cnt_reg_n_0_[0]\,
      I1 => \dly_gen.wait_cnt_reg_n_0_[1]\,
      O => \dly_gen.wait_cnt[2]_i_2_n_0\
    );
\dly_gen.wait_cnt[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F33FF33FFCCFEEEE"
    )
        port map (
      I0 => \p_1_in_carry__1_n_2\,
      I1 => \sm_state__0\(1),
      I2 => \dly_gen.wait_cnt[3]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[3]\,
      I4 => \sm_state__0\(0),
      I5 => \sm_state__0\(2),
      O => wait_cnt(3)
    );
\dly_gen.wait_cnt[3]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
      I0 => \dly_gen.wait_cnt_reg_n_0_[1]\,
      I1 => \dly_gen.wait_cnt_reg_n_0_[0]\,
      I2 => \dly_gen.wait_cnt_reg_n_0_[2]\,
      O => \dly_gen.wait_cnt[3]_i_2_n_0\
    );
\dly_gen.wait_cnt[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F33FF33FFCCFEEEE"
    )
        port map (
      I0 => \p_1_in_carry__1_n_2\,
      I1 => \sm_state__0\(1),
      I2 => \dly_gen.wait_cnt[4]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[4]\,
      I4 => \sm_state__0\(0),
      I5 => \sm_state__0\(2),
      O => wait_cnt(4)
    );
\dly_gen.wait_cnt[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I1 => \dly_gen.wait_cnt_reg_n_0_[0]\,
      I2 => \dly_gen.wait_cnt_reg_n_0_[1]\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[3]\,
      O => \dly_gen.wait_cnt[4]_i_2_n_0\
    );
\dly_gen.wait_cnt[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F33FF33FFCCFEEEE"
    )
        port map (
      I0 => \p_1_in_carry__1_n_2\,
      I1 => \sm_state__0\(1),
      I2 => \dly_gen.wait_cnt[5]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[5]\,
      I4 => \sm_state__0\(0),
      I5 => \sm_state__0\(2),
      O => wait_cnt(5)
    );
\dly_gen.wait_cnt[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      I4 => \dly_gen.wait_cnt_reg_n_0_[4]\,
      O => \dly_gen.wait_cnt[5]_i_2_n_0\
    );
\dly_gen.wait_cnt[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F33FF33FFCCFEEEE"
    )
        port map (
...
\dly_gen.wait_cnt[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \dly_gen.wait_cnt_reg_n_0_[4]\,
      I1 => \dly_gen.wait_cnt_reg_n_0_[2]\,
      I2 => \dly_gen.wait_cnt_reg_n_0_[0]\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[1]\,
      I4 => \dly_gen.wait_cnt_reg_n_0_[3]\,
      I5 => \dly_gen.wait_cnt_reg_n_0_[5]\,
      O => \dly_gen.wait_cnt[6]_i_2_n_0\
    );
\dly_gen.wait_cnt[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F33FF33FFCCFEEEE"
    )
        port map (
      I0 => \p_1_in_carry__1_n_2\,
      I1 => \sm_state__0\(1),
      I2 => \dly_gen.wait_cnt[7]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[7]\,
      I4 => \sm_state__0\(0),
      I5 => \sm_state__0\(2),
      O => wait_cnt(7)
    );
\dly_gen.wait_cnt[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \dly_gen.wait_cnt[6]_i_2_n_0\,
      I1 => \dly_gen.wait_cnt_reg_n_0_[6]\,
      O => \dly_gen.wait_cnt[7]_i_2_n_0\
    );
\dly_gen.wait_cnt[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F33FF33FFCCFEEEE"
    )
        port map (
      I0 => \p_1_in_carry__1_n_2\,
      I1 => \sm_state__0\(1),
      I2 => \dly_gen.wait_cnt[8]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[8]\,
      I4 => \sm_state__0\(0),
      I5 => \sm_state__0\(2),
      O => wait_cnt(8)
    );
\dly_gen.wait_cnt[8]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
      I0 => \dly_gen.wait_cnt_reg_n_0_[6]\,
      I1 => \dly_gen.wait_cnt[6]_i_2_n_0\,
      I2 => \dly_gen.wait_cnt_reg_n_0_[7]\,
      O => \dly_gen.wait_cnt[8]_i_2_n_0\
    );
\dly_gen.wait_cnt[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F33FF33FFCCFEEEE"
    )
        port map (
      I0 => \p_1_in_carry__1_n_2\,
      I1 => \sm_state__0\(1),
      I2 => \dly_gen.wait_cnt[9]_i_2_n_0\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[9]\,
      I4 => \sm_state__0\(0),
      I5 => \sm_state__0\(2),
      O => wait_cnt(9)
    );
\dly_gen.wait_cnt[9]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I1 => \dly_gen.wait_cnt[6]_i_2_n_0\,
      I2 => \dly_gen.wait_cnt_reg_n_0_[6]\,
      I3 => \dly_gen.wait_cnt_reg_n_0_[8]\,
      O => \dly_gen.wait_cnt[9]_i_2_n_0\
    );
...
p_1_in_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => p_1_in_carry_i_2_n_0,
      DI(1) => p_1_in_carry_i_3_n_0,
      DI(0) => p_1_in_carry_i_4_n_0,
      O(3 downto 0) => NLW_p_1_in_carry_O_UNCONNECTED(3 downto 0),
      S(3) => p_1_in_carry_i_5_n_0,
      S(2) => p_1_in_carry_i_6_n_0,
      S(1) => p_1_in_carry_i_7_n_0,
      S(0) => p_1_in_carry_i_8_n_0
    );
...
p_1_in_carry_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity csi2_d_phy_rx_0_csi2_d_phy_rx is
  ...
  attribute C_ADD_IDELAYCTRL of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is "FALSE";
  attribute C_CALIB_WAIT : integer;
  attribute C_CALIB_WAIT of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is 2047;
  ...
  attribute C_RATE_LIMIT of csi2_d_phy_rx_0_csi2_d_phy_rx : entity is 10;
...
architecture STRUCTURE of csi2_d_phy_rx_0_csi2_d_phy_rx is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \with_lp_gen.line_raw_sync[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \with_lp_gen.raw_valid[0]_i_1\ : label is "soft_lutpair7";
begin
...
architecture STRUCTURE of csi2_d_phy_rx_0 is
  ...
  attribute C_CALIB_WAIT : integer;
  attribute C_CALIB_WAIT of U0 : label is 2047;
  attribute C_D0_SWAP : string;
  ...
  attribute C_RATE_LIMIT : integer;
  attribute C_RATE_LIMIT of U0 : label is 10;
  attribute C_USE_DELAY : string;
