...
-- Date        : Wed Jul 29 21:55:06 2020
-- Host        : LAPTOP-9IQPJH1B running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top rgb2dvi_1 -prefix
--               rgb2dvi_1_ rgb2dvi_0_sim_netlist.vhdl
-- Design      : rgb2dvi_0
...
entity rgb2dvi_1_OutputSERDES is
  port (
...
end rgb2dvi_1_OutputSERDES;

architecture STRUCTURE of rgb2dvi_1_OutputSERDES is
  signal I : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_OutputSERDES_0 is
  port (
  ...
  attribute ORIG_REF_NAME of rgb2dvi_1_OutputSERDES_0 : entity is "OutputSERDES";
end rgb2dvi_1_OutputSERDES_0;

architecture STRUCTURE of rgb2dvi_1_OutputSERDES_0 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_OutputSERDES_2 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_1_OutputSERDES_2 : entity is "OutputSERDES";
end rgb2dvi_1_OutputSERDES_2;

architecture STRUCTURE of rgb2dvi_1_OutputSERDES_2 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_OutputSERDES_4 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_1_OutputSERDES_4 : entity is "OutputSERDES";
end rgb2dvi_1_OutputSERDES_4;

architecture STRUCTURE of rgb2dvi_1_OutputSERDES_4 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_SyncAsync is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    PixelClk : in STD_LOGIC;
    AS : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
end rgb2dvi_1_SyncAsync;

architecture STRUCTURE of rgb2dvi_1_SyncAsync is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_SyncAsync_6 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_1_SyncAsync_6 : entity is "SyncAsync";
end rgb2dvi_1_SyncAsync_6;

architecture STRUCTURE of rgb2dvi_1_SyncAsync_6 is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \rgb2dvi_1_SyncAsync__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \rgb2dvi_1_SyncAsync__parameterized1\ : entity is "SyncAsync";
end \rgb2dvi_1_SyncAsync__parameterized1\;

architecture STRUCTURE of \rgb2dvi_1_SyncAsync__parameterized1\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_TMDS_Encoder is
  port (
...
end rgb2dvi_1_TMDS_Encoder;

architecture STRUCTURE of rgb2dvi_1_TMDS_Encoder is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_TMDS_Encoder_1 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_1_TMDS_Encoder_1 : entity is "TMDS_Encoder";
end rgb2dvi_1_TMDS_Encoder_1;

architecture STRUCTURE of rgb2dvi_1_TMDS_Encoder_1 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_TMDS_Encoder_3 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_1_TMDS_Encoder_3 : entity is "TMDS_Encoder";
end rgb2dvi_1_TMDS_Encoder_3;

architecture STRUCTURE of rgb2dvi_1_TMDS_Encoder_3 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_ResetBridge is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    in0 : in STD_LOGIC;
    PixelClk : in STD_LOGIC
  );
end rgb2dvi_1_ResetBridge;

architecture STRUCTURE of rgb2dvi_1_ResetBridge is
  signal aRst_int : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int : signal is "true";
begin
  aRst_int <= in0;
SyncAsyncx: entity work.rgb2dvi_1_SyncAsync
     port map (
      AS(0) => aRst_int,
      PixelClk => PixelClk,
      \out\(0) => \out\(0)
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_1_ResetBridge_5 is
  port (
    AS : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_1_ResetBridge_5 : entity is "ResetBridge";
end rgb2dvi_1_ResetBridge_5;

architecture STRUCTURE of rgb2dvi_1_ResetBridge_5 is
  signal aRst_int : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int : signal is "true";
begin
  aRst_int <= aRst;
SyncAsyncx: entity work.rgb2dvi_1_SyncAsync_6
     port map (
      AS(0) => AS(0),
...
end rgb2dvi_1_ClockGen;

architecture STRUCTURE of rgb2dvi_1_ClockGen is
...
LockLostReset: entity work.rgb2dvi_1_ResetBridge_5
     port map (
      AS(0) => pRst,
      aRst => aRst,
      \oSyncStages_reg[1]\ => \oSyncStages_reg[1]\
    );
PLL_LockSyncAsync: entity work.\rgb2dvi_1_SyncAsync__parameterized1\
     port map (
      D(0) => oOut,
...
entity rgb2dvi_1_rgb2dvi is
  ...
  attribute kClkPrimitive of rgb2dvi_1_rgb2dvi : entity is "MMCM";
  attribute kClkRange : integer;
  attribute kClkRange of rgb2dvi_1_rgb2dvi : entity is 1;
  attribute kGenerateSerialClk : string;
  attribute kGenerateSerialClk of rgb2dvi_1_rgb2dvi : entity is "TRUE";
  attribute kRstActiveHigh : string;
  attribute kRstActiveHigh of rgb2dvi_1_rgb2dvi : entity is "TRUE";
end rgb2dvi_1_rgb2dvi;

architecture STRUCTURE of rgb2dvi_1_rgb2dvi is
  ...
  signal p_1_in : STD_LOGIC;
begin
\ClockGenInternal.ClockGenX\: entity work.rgb2dvi_1_ClockGen
     port map (
      PixelClk => PixelClkIO,
...
ClockSerializer: entity work.rgb2dvi_1_OutputSERDES
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[0].DataEncoder\: entity work.rgb2dvi_1_TMDS_Encoder
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[0].DataSerializer\: entity work.rgb2dvi_1_OutputSERDES_0
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[1].DataEncoder\: entity work.rgb2dvi_1_TMDS_Encoder_1
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[1].DataSerializer\: entity work.rgb2dvi_1_OutputSERDES_2
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[2].DataEncoder\: entity work.rgb2dvi_1_TMDS_Encoder_3
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[2].DataSerializer\: entity work.rgb2dvi_1_OutputSERDES_4
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
LockLostReset: entity work.rgb2dvi_1_ResetBridge
     port map (
      PixelClk => PixelClk,
      in0 => aRstLck,
      \out\(0) => pRstLck
...
entity rgb2dvi_1 is
  ...
  attribute NotValidForBitStream of rgb2dvi_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of rgb2dvi_1 : entity is "rgb2dvi_0,rgb2dvi,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of rgb2dvi_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of rgb2dvi_1 : entity is "rgb2dvi,Vivado 2018.3";
end rgb2dvi_1;

architecture STRUCTURE of rgb2dvi_1 is
  attribute kClkPrimitive : string;
...
begin
U0: entity work.rgb2dvi_1_rgb2dvi
     port map (
      PixelClk => PixelClk,
      SerialClk => '0',
      TMDS_Clk_n => TMDS_Clk_n,
